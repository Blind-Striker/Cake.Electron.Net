    ...
    public class ElectronNetBuilderCustomTests
    {
        ...
        public void ElectronNetBuildCustom_Should_Execute_Command_By_Given_WorkingDirectory_ElectronTarget_And_DotnetConfig_And_ElectronArch_And_RelativePath()
        {
            ...
            string expectedCommand =
                $"{CmdBase} /target custom {electronTarget} /dotnet-configuration {dotnetConfig} /electron-arch {electronArch} /relative-path {relativePath}";
        ...
        public void ElectronNetBuildCustom_Should_Execute_Command_By_Given_WorkingDirectory_ElectronTarget_And_DotnetConfig_And_ElectronArch_And_AbsolutePath()
        {
            ...
            string expectedCommand =
                $"{CmdBase} /target custom {electronTarget} /dotnet-configuration {dotnetConfig} /electron-arch {electronArch} /absolute-path {absolutePath}";
        ...
        [Fact]
        public void
            ElectronNetBuildCustom_Should_Execute_Command_By_Given_WorkingDirectory_ElectronTarget_And_DotnetConfig_And_ElectronArch_And_AbsolutePath_And_PackageJson()
        {
            ICakeContext cakeContext = _cakeContextMock.Object;
            ...
            string expectedCommand =
                $"{CmdBase} /target custom {electronTarget} /dotnet-configuration {dotnetConfig} /electron-arch {electronArch} /absolute-path {absolutePath} /package-json {packageJson}";
        ...
        [Fact]
        public void
            ElectronNetBuildCustom_Should_Execute_Command_By_Given_WorkingDirectory_ElectronTarget_And_DotnetConfig_And_ElectronArch_And_AbsolutePath_And_PackageJson_And_InstallModules()
        {
            ICakeContext cakeContext = _cakeContextMock.Object;
            ...
            string expectedCommand =
                $"{CmdBase} /target custom {electronTarget} /dotnet-configuration {dotnetConfig} /electron-arch {electronArch} /absolute-path {absolutePath} /package-json {packageJson} /install-modules";
        ...
        [Fact]
        public void
            ElectronNetBuildCustom_Should_Execute_Command_By_Given_WorkingDirectory_ElectronTarget_And_DotnetConfig_And_ElectronArch_And_AbsolutePath_And_PackageJson_And_InstallModules_And_Manifest()
        {
            ICakeContext cakeContext = _cakeContextMock.Object;
            ...
            string expectedCommand =
                $"{CmdBase} /target custom {electronTarget} /dotnet-configuration {dotnetConfig} /electron-arch {electronArch} /absolute-path {absolutePath} /package-json {packageJson} /install-modules /manifest {manifest}";
            ...
            cakeContext.ElectronNetBuildCustom(workingDirectory, electronTarget, electronArch, dotnetConfig, null, absolutePath, packageJson, installModules, manifest);
        ...
        [Fact]
        public void
            ElectronNetBuildCustom_Should_Execute_Command_By_Given_WorkingDirectory_ElectronTarget_And_DotnetConfig_And_ElectronArch_And_AbsolutePath_And_PackageJson_And_InstallModules_And_Manifest_And_ElectronParams()
        {
            ICakeContext cakeContext = _cakeContextMock.Object;
            ...
            string expectedCommand =
                $"{CmdBase} /target custom {electronTarget} /dotnet-configuration {dotnetConfig} /electron-arch {electronArch} /absolute-path {absolutePath} /package-json {packageJson} /install-modules /manifest {manifest} /electron-params \"--command=conquer\"";
            ...
            cakeContext.ElectronNetBuildCustom(workingDirectory, electronTarget, electronArch, dotnetConfig, null, absolutePath, packageJson, installModules, manifest,
                                               PublishSingleFile, PublishReadyToRun, electronParams);
